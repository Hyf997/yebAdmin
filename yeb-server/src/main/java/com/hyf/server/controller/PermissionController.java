...
import com.hyf.server.service.impl.MenuRoleServiceImpl;
import com.hyf.server.service.impl.MenuServiceImpl;
...
public class PermissionController {
    ...
    public List<Integer> getMidByRid(@PathVariable Integer rid){
        return menuRoleService.list(new QueryWrapper< MenuRole>().eq(
                "rid",rid
        )).stream()
                .map(MenuRole::getMid)
